...
final List<Azkar> morningAzkarList = [
  Azkar(
    id: 'morning_1',
    category: 'morning', // إضافة هذا السطر لحل المشكلة
  ...
  Azkar(
    ...
    comment:
        'من قالها موقنا بها حين يصبح وحين يمسى كان حقا على الله أن يرضيه يوم القيامة.',
    target: 3,
  ),
  Azkar(
    id: 'morning_8',
  ...
  Azkar(
    ...
    comment: 'من قالها حين يصبح أدى شكر يومه.',
    target: 1,
  ),
  Azkar(
    id: 'morning_10',
