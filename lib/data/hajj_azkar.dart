...
final List<Azkar>hajjAzkarList=[
  Azkar(id: 'hajj_1',
   category: 'hajj', 
   text: '''
...
''',
 ...
 target: 1),
  Azkar(id: 'hajj_5',
   ...
   comment: ''' [الطبراني (862)، (863)، والبيهقي (5/ 79)]
   [الطبراني (865)]''',
 target: 1),
  Azkar(id: 'hajj_6',
   category: 'hajj', 
   ...
   comment: '[أبو داود 2/179 وأحمد 3/411]',
 target: 1),
  Azkar(id: 'hajj_7',
   category: 'hajj', 
   header: 'الدعاء في الطواف',
   ...
   comment: '[الطبراني (857)، والبيهقي (5/ 84)]',
 target: 1),
  Azkar(id: 'hajj_8',
   category: 'hajj', 
...
اللَّهُمَّ يَسِّرْنِي لِلْيُسْرَى، وَجَنِّبْنِي الْعُسْرَى، وَاغْفِرْ.''',
 target: 1),
  Azkar(id: 'hajj_9',
   category: 'hajj', 
   header: 'الدعاء عند صعود الصَّفَا والمروة',
   text: '''عَنْ جَابِرِ بْنِ عَبْدِ اللَّهِ رضي الله عنه، قَالَ: سَمِعْتُ رَسُولَ اللَّهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ حِينَ خَرَجَ مِنَ الْمَسْجِدِ يُرِيدُ الصَّفَا، يَقُولُ: "نَبْدَأُ بِمَا بَدَأَ بِهِ" فَبَدأَ بِالصَّفَا، وَقَرَأَ: {إِنَّ الصَّفَا وَالمَرْوَةَ مِنْ شَعَائِرِ اللَّهِ} وَكَانَ إِذَا وَقَفَ عَلَى الصَّفَا يُكَبِّرُ ثَلاثًا، وَيَقُولُ:
...
comment: '[مسلم (1218)، وأحمد (3/ 320، 321)]',
 target: 1),
  Azkar(id: 'hajj_10',
   category: 'hajj', 
   header: 'الدعاء على الصفا',
...
comment: '[البيهقي (5/ 94)]',
 target: 1),
  Azkar(id: 'hajj_11',
   category: 'hajj', 
   header: 'الدعاء في السعي بين الصفا والمروة',
   text: '"رَبِّ اغْفِرْ وَارْحَمْ إِنَّكَ أَنْتَ الْأَعَزُّ الْأَكْرَمُ"',
   comment: ' [الطبراني (870)، والبيهقي (5/ 95)]',
 target: 1),
  Azkar(id: 'hajj_12',
   category: 'hajj', 
   header: 'الدعاء بعرفات',
...
comment: '[الترمذي (3579)، والطبراني (784)]',
 target: 1),
  Azkar(id: 'hajj_13',
   category: 'hajj', 
   header: 'دعاء السلف الصالح في عرفات',
   text: '''"لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ".
 ...
 target: 1),
  Azkar(id: 'hajj_14',
   category: 'hajj', 
   header: 'الدعاء عند رمي جمرة العقبة عِنْدَ كُلِّ حَصَاة',
   text: '''"الله أَكْبَر، الله أَكْبَر، الله أَكْبَر".
"اللَّهُمَّ اجْعَلْهُ حَجًّا مَبْرُورًا وَذَنْبًا مَغْفُورًا".''',
comment: '[الطبراني (881)، والبيهقي (5/ 129)]',
 target: 1),
  Azkar(id: 'hajj_15',
   category: 'hajj', 
   header: 'الذكر عند ذبح الأضاحي',
   text: '''بسم الله
 ...
 target: 1),
  Azkar(id: 'hajj_16',
   category: 'hajj', 
   header: 'دعاء الرجوع من الحج أو العمرة',
   text: '''"الله أَكْبَر، الله أَكْبَر، الله أَكْبَر".
