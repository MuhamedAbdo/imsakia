...
class QuranUtils {
  ...
  static List<InlineSpan> buildSpansFromParsed(
    ...
    final Color targetAyaColor = isDarkMode
    ...
    for (var parsed in parsedWords) {
      ...
      TextStyle baseStyle = TextStyle(
        ...
        backgroundColor: parsed.isHighlight
            ? highlightColor
            : (isTargetAya ? targetAyaColor : null),
      );

      // We add the word without the trailing space to prevent RTL style bleeding across lines
      spans.add(
        TextSpan(text: parsed.text, style: baseStyle, recognizer: recognizer),
      );
